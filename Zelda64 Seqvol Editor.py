  ...
  try:
    if filepath.endswith('.ootrs') or filepath.endswith('.mmrs'):
      ...
      with tempfile.TemporaryDirectory() as tempfolder:
        unpack_thread = threading.Thread(target=archive.unpack_archive, args=(tempfolder,))
        ...
        repack_thread = threading.Thread(target=archive.repack_archive, args=(tempfolder,))
